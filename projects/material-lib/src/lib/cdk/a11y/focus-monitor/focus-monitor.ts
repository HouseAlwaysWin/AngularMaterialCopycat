...
import { Platform, normalizePassiveListenerOptions, _getShadowRoot } from '../../platform';
import {
    Directive,
    ElementRef,
    EventEmitter,
...
export class FocusMonitor implements OnDestroy {
    ...
    private _touchTimeoutId: null | ReturnType<typeof setTimeout> = null;

    /** The timeout id of the window focus timeout. */
    private _windowFocusTimeoutId: number;

    /** The timeout id of the origin clearing timeout. */
    private _originTimeoutId: null | ReturnType<typeof setTimeout> = null;
